        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa fa-table"></i>Lihat Dokumentasi</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="mainpage.php">Home</a></li>
                                <li><i class="fa fa-pencil-square-o"></i>Kelola Dokumentasi</li>
                                <li><i class="fa fa-table"></i>Lihat Dokumentasi</li>
                            </ol>
                        </div>
                    </div>
                                                            ...
                                                            while ($data = mysql_fetch_array($sql)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <br>
                                                                        <!-- Edit-->
                                                                        <a href="edit_dokumentasi.php?hal=edit&kd=<?php echo $data['id_dokumentasi']; ?>" class="btn btn-default btn-small btn-dark">Edit</a>
                                                                        <!--Hapus-->
                                                                        <a onclick="return confirm('Yakin hapus <?php echo $data['judul_dokumentasi']; ?> ?');" 
                                                                           href="../proses/deletdokumen.php?hal=hapus&kd=<?php echo $data['id_dokumentasi']; ?>" 
                                                                           class="btn btn-default btn-small btn-dark"><span class="glyphicon glyphicon-trash"></span></a>
                                                                    </td>
                                                                </tr>	
                                                                <?php $no++;
                                                            } ?>
