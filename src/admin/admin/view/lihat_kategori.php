...
<html lang="en">
    <head>
        ...
        <title>Lihat Kategori | e-Dokumentasi</title>
    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header dark-bg">
                ...
                <!--logo start-->
                <a href="mainpage.php" class="logo">Sistem <span class="lite">Neera</span></a>
                <!--logo end-->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa fa-table"></i>Lihat Pembelian</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="mainpage.php">Home</a></li>
                                <li><i class="fa fa-pencil-square-o"></i>Kelola Barang</li>
                                <li><i class="fa fa-table"></i>Lihat Pembelian</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div id="recent-activity" class="tab-pane active">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <table class="table table-hover row-border " style = 'text-align : center' cellspacing="0" width="100%">
                                                        <thead class="bg-info">
                                                            <tr>
                                                                <th>Id.</th>
                                                                <th>Kategori</th>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $no = 1;
                                                            $query = "SELECT *from tb_kategori_dokumentasi order by id_kategori ";
