...
<html lang="en">
    <head>
        ...
        <title>Detail Dokumentasi | e-Dokumentasi</title>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa fa-file"></i>Detail Dokumentasi</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="mainpage.php">Home</a></li>
                                <li><i class="fa fa-pencil-square-o"></i>Kelola Dokumentasi</li>
                                <li><i class="fa fa-file"></i>Detail Dokumentasi</li>
                            </ol>
                        </div>
                    </div>
